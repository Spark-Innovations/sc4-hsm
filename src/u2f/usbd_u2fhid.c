...
/**
  ...
  *         Initialize the U2F_HID interface
...
/**
  * @brief  USBD_U2F_HID_Init
  *         DeInitialize the U2F_HID layer
  * @param  pdev: device instance
  * @param  cfgidx: Configuration index
  * @retval status
  */
...
/**
  * @brief  USBD_U2F_HID_Setup
  *         Handle the U2F_HID specific requests
  * @param  pdev: instance
...
/**
  * @brief  USBD_U2F_HID_EP0_RxReady
...
/**
* @brief  USBD_U2F_HID_RegisterInterface
  * @param  pdev: device instance
